...
const handelSearch = async (e) => {
  ...
  picpikUl.setAttribute("id", "picpik-list");
  ...
  if (Object.keys(res).length > 0) {
    ...
    resSort.start.forEach((element) => {
      ...
      imageElement.setAttribute(
        "class",
        "object-scale-down w-40 h-max-80 rounded-md my-2"
      );
  ...
  picpikContentElement.append(picpikUl, picpikHR, picpikUlEnd);
  ...
  if (picpikContent === null) {
    /*
      ...
      clearButtonElement.setAttribute(
        "class",
        "static w-15 h-15 top-15 start-0 flex items-center ps-3 pointer-events-none bg-slate-900 rounded-md z-20"
        );
        
        clearButtonElement.innerHTML =
      "<svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke-width='1.5' stroke='currentColor' class='w-15 h-15 z-20'><path stroke-linecap='round' stroke-linejoin='round' d='m9.75 9.75 4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z' /></svg>";
*/
  }
  /*
  if (picpikList) {
